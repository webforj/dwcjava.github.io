"use strict";(self.webpackChunkdwcj_documentation=self.webpackChunkdwcj_documentation||[]).push([[7643,8401],{5124:(e,t,n)=>{n.r(t),n.d(t,{default:()=>g});n(6540);var o=n(8215),r=n(4586),i=n(5500),s=n(7559),a=n(8027),c=n(7713),l=n(1463),d=n(3892),h=n(5260),p=n(4096),m=n(4848);function A(e){const t=(0,p.kJ)(e);return(0,m.jsx)(h.A,{children:(0,m.jsx)("script",{type:"application/ld+json",children:JSON.stringify(t)})})}function u(e){const{metadata:t}=e,{siteConfig:{title:n}}=(0,r.A)(),{blogDescription:o,blogTitle:s,permalink:a}=t,c="/"===a?n:s;return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(i.be,{title:c,description:o}),(0,m.jsx)(l.A,{tag:"blog_posts_list"})]})}function v(e){const{metadata:t,items:n,sidebar:o}=e;return(0,m.jsxs)(a.A,{sidebar:o,children:[(0,m.jsx)(d.A,{items:n}),(0,m.jsx)(c.A,{metadata:t})]})}function g(e){return(0,m.jsxs)(i.e3,{className:(0,o.A)(s.G.wrapper.blogPages,s.G.page.blogListPage),children:[(0,m.jsx)(u,{...e}),(0,m.jsx)(A,{...e}),(0,m.jsx)(v,{...e})]})}},7713:(e,t,n)=>{n.d(t,{A:()=>s});n(6540);var o=n(1312),r=n(9022),i=n(4848);function s(e){const{metadata:t}=e,{previousPage:n,nextPage:s}=t;return(0,i.jsxs)("nav",{className:"pagination-nav","aria-label":(0,o.T)({id:"theme.blog.paginator.navAriaLabel",message:"Blog list page navigation",description:"The ARIA label for the blog pagination"}),children:[n&&(0,i.jsx)(r.A,{permalink:n,title:(0,i.jsx)(o.A,{id:"theme.blog.paginator.newerEntries",description:"The label used to navigate to the newer blog posts page (previous page)",children:"Newer entries"})}),s&&(0,i.jsx)(r.A,{permalink:s,title:(0,i.jsx)(o.A,{id:"theme.blog.paginator.olderEntries",description:"The label used to navigate to the older blog posts page (next page)",children:"Older entries"}),isNext:!0})]})}},3892:(e,t,n)=>{n.d(t,{A:()=>s});n(6540);var o=n(4096),r=n(1240),i=n(4848);function s(e){let{items:t,component:n=r.A}=e;return(0,i.jsx)(i.Fragment,{children:t.map((e=>{let{content:t}=e;return(0,i.jsx)(o.in,{content:t,children:(0,i.jsx)(n,{children:(0,i.jsx)(t,{})})},t.metadata.permalink)}))})}},3152:(e,t,n)=>{n.d(t,{A:()=>s});n(6540);var o=n(7437),r=n(8774),i=n(2445);function s(e){let{imagePath:t,title:n,description:s,link:a}=e;const c=o.AH`
    display: flex;
  ...
  `;return(0,v.Y)("div",{css:o,children:(0,v.Y)("button",{css:i,onClick:()=>{n(!t)},children:t?(0,v.Y)("img",{alt:"collapse_button",css:a,src:h,className:"icon-tabler-arrow-bar-up"}):(0,v.Y)("img",{css:a,src:p,className:"icon-tabler-arrow-bar-down"})})})}function b(e){let{url:t}=e;const n=r.AH`
    position: relative;
    cursor: pointer;
    z-index: 10;
    height: 35px;
  ...
  `;return(0,v.Y)("button",{css:n,onClick:()=>{window.open(t,"_blank")},children:(0,v.Y)("img",{css:o,src:m})})}function f(e){let{path:t,javaC:n,javaE:i,urls:h,cssURL:p,javaHighlight:m,height:x,frame:w,tabs:j}=e;f.propTypes={path:s().string.isRequired,javaC:s().string,javaE:s().string,urls:s().arrayOf(s().string),cssURL:s().string,javaHighlight:s().string,height:s().string,frame:s().string,tabs:s().arrayOf(s().string)};const[k,D]=(0,o.useState)(""),[y,E]=(0,o.useState)(""),[Y,B]=(0,o.useState)({}),[C,S]=(0,o.useState)(""),[L,H]=(0,o.useState)(!(!n||!i)),[M,F]=(0,o.useState)(!1),[N,O]=(0,o.useState)({}),[T,G]=(0,o.useState)(!1),[J,P]=(0,o.useState)(0),[z,X]=(0,o.useState)(0),[R,Z]=(0,o.useState)(25),[W,V]=(0,o.useState)(25),[U,I]=(0,o.useState)(0),[K,q]=(0,o.useState)(!1),Q=(0,o.useRef)(null),_=(0,o.useRef)(null);function $(e,t,n){return(0,v.Y)(d.A,{css:t,className:"codeDemoBlock",language:"java",showLineNumbers:!0,metastring:n,children:e.code})}(0,o.useEffect)((()=>{i&&fetch(i).then((e=>e.text())).then((e=>{E(e);const t=new URL(i).pathname.split("/"),n=t[t.length-1];O((e=>({...e,javaFile:n})))})),n&&fetch(n).then((e=>e.text())).then((e=>{D(e)})),p&&fetch(p).then((e=>e.text())).then((e=>{S(e);const t=new URL(p).pathname.split("/"),n=t[t.length-1];O((e=>({...e,cssFile:n})))})),h&&h.forEach((function(e){const t=new URL(e),n=t.pathname.split("/"),o=n[n.length-1];fetch(e).then((e=>e.text())).then((e=>{!function(e,t){B((n=>({...n,[e]:{fileName:e,code:t}})))}(o,e)}))})),I(Q.current?Q.current.offsetWidth:0)}),[]);const ee=()=>{G(!1)},te=e=>{if(T){const t=e.clientX-J;z+t>U/3&&(Q.current.style.width=`${z+t}px`,_.current.style.right=(R-t<25?25:R-t)+"px",V(R-t<25?25:R-t))}},ne=r.AH`
    display: flex;
    flex-direction: column;
    width: 100%;
    margin-bottom: 16px;
  ...
  `;return(0,v.FD)("div",{css:ne,onMouseUp:ee,onMouseLeave:ee,onMouseMove:te,children:["hidden"!=w?(0,v.FD)("div",{onMouseEnter:()=>{F(!0)},onMouseLeave:()=>F(!1),css:oe,children:[(0,v.Y)("iframe",{onMouseUp:ee,loading:"lazy",src:t+"&__theme__="+(0,A.G)().colorMode,css:re,ref:Q,onMouseMove:te}),(0,v.Y)("div",{css:ie,ref:_,children:(0,v.Y)(b,{url:t})}),(0,v.Y)("div",{css:se,onMouseDown:e=>{e.preventDefault(),G(!0),P(e.clientX),X(Q.current?Q.current.offsetWidth:0),Z(W)},children:(0,v.Y)(u.A,{})})]}):null,(0,v.FD)(l.A,{css:ae,summary:(0,v.Y)("summary",{onClick:()=>q(!K),children:K?"Hide Code":"Show Code"}),children:[n&&i?(0,v.Y)(g,{collapse:L,setCollapse:H}):null,p?(0,v.FD)(a.A,{css:ce,children:[(0,v.Y)(c.A,{value:j?j[0]:"Java",label:j?j[0]:N.javaFile,default:!0,children:(0,v.Y)(d.A,{css:le,className:"codeDemoBlock",language:"java",showLineNumbers:!0,metastring:m,children:L?k:y})}),Object.keys(Y).map(((e,t)=>(0,v.Y)(c.A,{value:e,label:e,children:$(Y[e],le,m)},"tab"+t))),(0,v.Y)(c.A,{value:j?j[1]:"CSS",label:j?j[1]:N.cssFile,children:(0,v.Y)(d.A,{css:le,className:"codeDemoBlock",language:"css",showLineNumbers:!0,children:C})})]}):(0,v.FD)(a.A,{css:ce,children:[(0,v.Y)(c.A,{value:j?j[0]:"Java",label:j?j[0]:N.javaFile,default:!0,children:(0,v.Y)(d.A,{css:le,className:"codeDemoBlock",language:"java",showLineNumbers:!0,metastring:m,children:L?k:y})}),Object.keys(Y).map(((e,t)=>(0,v.Y)(c.A,{value:e,label:e,children:$(Y[e],le,m)},"tab"+t)))]})]})]})}},5529:(e,t,n)=>{n.d(t,{A:()=>h});n(6540);var o=n(7437),r=n(276),i=n(526),s=n(4863),a=n(4303),c=n(4680),l=n(8144),d=n(2445);function h(e){let{chip:t,label:n,href:h,clickable:p,iconName:m,tooltipText:A,color:u}=e;const v=o.AH`
    margin-right: 0.5em;
    margin-bottom: 1em;
  ...
  `;let b;return"shadow"===t?(A="This component renders with a shadow DOM, an API built into the browser that facilitates encapsulation.",p=!0,h="https://documentation.webforj.com/docs/glossary#shadow-dom",n="Shadow",m="shadow"):"name"===t?(A="The name of this web component as it appears in the DOM.",p=!1,m="code"):"scoped"==t&&(A="This component uses scoped components, an alternative approach to the shadow DOM, a browser API that enables encapsulation. These components scope their styles to avoid leaks or conflicts instead of relying on the native shadow DOM.",p=!1,n="Scoped",m="scoped"),b="shadow"===m?(0,d.Y)(a.A,{css:g}):"code"===m?(0,d.Y)(c.A,{css:g}):"scoped"===m?(0,d.Y)(s.A,{css:g}):(0,d.Y)(l.A,{css:g}),(0,d.Y)(r.A,{title:A,arrow:!0,css:v,children:(0,d.Y)(i.A,{className:`doc-chip ${t.className||""}`,label:n,component:"a",href:p?h:null,icon:b,clickable:p,color:u,target:"_blank"})})}},3235:(e,t,n)=>{n.d(t,{A:()=>l});var o=n(6540),r=n(7437),i=n(276),s=n(526),a=n(7785),c=n(2445);function l(e){let{type:t,location:n,top:l,children:d,code:h,suffix:p}=e;const[m,A]=(0,o.useState)(""),[u,v]=(0,o.useState)(!1);(0,o.useEffect)((()=>{document.querySelectorAll(".doc-chip").length>0?v(!0):v(!1)}),[]),(0,o.useEffect)((()=>{!async function(){const e=p||"",o="webforj_latest_version",r=localStorage.getItem(o),i=localStorage.getItem(`${o}_timestamp`);if(r&&i&&Date.now()-i<864e5){A(`https://javadoc.io/doc/com.webforj/webforj-${t}/${r}/${n}.html${e}`)}else try{const r=await fetch("https://api.github.com/repos/webforj/webforj/releases/latest");if(!r.ok)throw new Error(`GitHub API error: ${r.statusText}`);const i=(await r.json()).tag_name;console.log(i),localStorage.setItem(o,i),localStorage.setItem(`${o}_timestamp`,Date.now()),A(`https://javadoc.io/doc/com.webforj/webforj-${t}/${i}/${n}.html${e}`)}catch(s){console.error("Failed to fetch the latest version:",s),A(`https://javadoc.io/doc/com.webforj/webforj-${t}/latest/${n}.html${e}`)}}()}),[t,n,p]);const g=r.AH`
    ${e=>e&&r.AH`
        margin-bottom: 1em;
        margin-left: 0.5em;
        float: right;
