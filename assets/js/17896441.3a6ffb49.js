"use strict";(self.webpackChunkdwcj_documentation=self.webpackChunkdwcj_documentation||[]).push([[8401],{53152:(e,t,n)=>{n.d(t,{A:()=>s});n(96540);var o=n(17437),r=n(28774),i=n(2445);function s(e){let{imagePath:t,title:n,description:s,link:a}=e;const c=o.AH`
  ...
  `;let b;if("shadow"===t)A="This component renders with a shadow DOM, an API built into the browser that facilitates encapsulation.",h="https://documentation.webforj.com/docs/glossary#shadow-dom",n="Shadow",m="shadow";else if("name"===t){if(A="The name of this web component as it appears in the DOM.",!p){const e="https://docs.webforj.com/docs/client-components/",t=n.replace("dwc-","");h=e.concat(t)}m="code"}else"scoped"==t&&(A="This component uses scoped components, an alternative approach to the shadow DOM, a browser API that enables encapsulation. These components scope their styles to avoid leaks or conflicts instead of relying on the native shadow DOM.",p="true",n="Scoped",m="scoped");return b="shadow"===m?(0,d.Y)(a.A,{css:g}):"code"===m?(0,d.Y)(c.A,{css:g}):"scoped"===m?(0,d.Y)(s.A,{css:g}):(0,d.Y)(l.A,{css:g}),(0,d.Y)(r.A,{title:A,arrow:!0,css:v,children:(0,d.Y)(i.A,{className:`doc-chip ${t.className||""}`,label:n,component:"a",href:p?null:h,icon:b,clickable:!p,color:u,target:"_blank"})})}},33235:(e,t,n)=>{n.d(t,{A:()=>l});var o=n(96540),r=n(17437),i=n(56655),s=n(68096),a=n(37785),c=n(2445);function l(e){let{type:t,location:n,top:l,children:d,code:h,suffix:p}=e;const[m,A]=(0,o.useState)(""),[u,v]=(0,o.useState)(!1);(0,o.useEffect)((()=>{document.querySelectorAll(".doc-chip").length>0?v(!0):v(!1)}),[]),(0,o.useEffect)((()=>{!async function(){const e=p||"",o="webforj_latest_version",r=localStorage.getItem(o),i=localStorage.getItem(`${o}_timestamp`);if(r&&i&&Date.now()-i<864e5){A(`https://javadoc.io/doc/com.webforj/webforj-${t}/${r}/${n}.html${e}`)}else try{const r=await fetch("https://api.github.com/repos/webforj/webforj/releases/latest");if(!r.ok)throw new Error(`GitHub API error: ${r.statusText}`);const i=(await r.json()).tag_name;console.log(i),localStorage.setItem(o,i),localStorage.setItem(`${o}_timestamp`,Date.now()),A(`https://javadoc.io/doc/com.webforj/webforj-${t}/${i}/${n}.html${e}`)}catch(s){console.error("Failed to fetch the latest version:",s),A(`https://javadoc.io/doc/com.webforj/webforj-${t}/latest/${n}.html${e}`)}}()}),[t,n,p]);const g=r.AH`
    ${e=>e&&r.AH`
        margin-bottom: 1em;
        margin-left: 0.5em;
        float: right;
